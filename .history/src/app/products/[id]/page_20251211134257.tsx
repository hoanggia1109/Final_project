                ...
                <div className="mb-4 d-flex flex-column flex-md-row align-items-start align-items-md-center gap-3">
                  ...
                  {product.colors && product.colors.length > 0 && (
                    <div style={{ flex: 1, minWidth: 0, width: '100%' }}>
                      <h6 className="mb-2 fw-semibold" style={{ color: '#2c3e50', letterSpacing: '0.5px', fontSize: '0.95rem' }}>
                        {product.colors[selectedColor]?.mausac ? `Bạn đang chọn ${product.colors[selectedColor].mausac}` : 'Chọn biến thể'}
                      </h6>
