          ...
          <div className="row g-5" style={{ marginLeft: 0, marginRight: 0 }}>
            ...
            <div className={isMobile ? "col-12" : "col-lg-6"}>
              <div className="product-info-card">
                ...
                {/* Stock Status & Variant Selection */}
                <div className="mb-4 d-flex flex-column flex-md-row align-items-start align-items-md-center gap-3">
                  {/* Stock Status */}
                  ...
                  {product.colors && product.colors.length > 0 && (
                    <div style={{ flex: 1, minWidth: 0, width: '100%' }}>
                      <h6 className="mb-2 fw-semibold" style={{ color: '#2c3e50', letterSpacing: '0.5px', fontSize: '0.95rem' }}>Chọn biến thể</h6>
                      ...
                      {product.colors.map((variant, index) => {
                        ...
                        return (
                          <label
                            key={index}
                            className={`variant-radio-option ${isSelected ? 'active' : ''} ${isOutOfStock ? 'out-of-stock' : ''}`}
                            style={{
                              display: 'flex',
                              alignItems: 'flex-start',
                              padding: '10px 12px',
                              border: `2px solid ${isSelected ? '#FF6B6B' : '#FFE5D9'}`,
                              borderRadius: '8px',
                              cursor: isOutOfStock ? 'not-allowed' : 'pointer',
                              background: isSelected ? 'linear-gradient(135deg, #FFF5F0, #FFE5E0)' : '#FFFFFF',
                              transition: 'all 0.3s ease',
                          ...
                          >
                            ...
                            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '4px' }}>
                              {variant.mausac && (
                                <span className="fw-semibold" style={{ color: '#2c3e50', fontSize: '0.9rem' }}>
                                  Màu: {variant.mausac}
                                </span>
                              )}
                              {variant.kichthuoc && (
                              ...
                              {variant.gia && variant.gia > 0 && (
                                <span style={{ color: '#FF6B6B', fontSize: '0.95rem', fontWeight: '600' }}>
                                  {formatPrice(variant.gia)}
                                </span>
                              )}
                              <span style={{ 
                                fontSize: '0.85rem', 
                                color: isOutOfStock ? '#dc3545' : (variant.stock && variant.stock > 10 ? '#28a745' : '#FFA726'),
                                fontWeight: '600'
                              }}>
