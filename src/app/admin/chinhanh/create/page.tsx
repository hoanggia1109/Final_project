...
export default function CreateChiNhanhPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert('❌ Lỗi: ' + (data.message || 'Không thể thêm chi nhánh'));
      }
    } catch (err) {
      console.error(err);
        ...
        <div className="container">
          ...
          <div className="form-header">
            <div className="d-flex align-items-center gap-3 mb-3">
              ...
              <div>
                <h3 className="fw-bold mb-0" style={{ color: '#2C3E50' }}>Thêm Chi nhánh mới</h3>
                <p className="text-muted mb-0 small">Điền thông tin chi nhánh mới</p>
              </div>
            </div>
          </div>
