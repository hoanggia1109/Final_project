            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div className="card shadow-sm mb-4">
                <div className="card-body p-4">
                  ...
                  {errors.city && <div className="text-danger small mb-3">{errors.city}</div>}
                  {errors.district && <div className="text-danger small mb-3">{errors.district}</div>}
                  {errors.ward && <div className="text-danger small mb-3">{errors.ward}</div>}
