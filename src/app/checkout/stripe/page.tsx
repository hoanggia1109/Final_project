    ...
    >
      <div className="container">
        ...
        <div className="row g-4">
          ...
          <div className="col-lg-6">
            <div className="card border-0 shadow-sm rounded-4" style={{ position: 'relative', zIndex: 1 }}>
                ...
                {clientSecret && stripePromise ? (
                  <Elements
                    ...
                    options={{
                      ...
                      locale: 'en', // Dùng 'en' để hiển thị "Visa" thay vì "Visa Ghi Có"
                    }}
                    key={clientSecret}
                  >
                  <StripePaymentForm
                  ...
                  <div className="text-center py-4">
                    ...
                    <p className="text-muted mt-3">Đang khởi tạo form thanh toán...</p>
                  </div>
                )}
